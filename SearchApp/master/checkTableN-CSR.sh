#!/bin/bash
for dir in /home2/vvsaripalli/master/master/*/
do	
			for file in $dir/*
			do (
				 if grep -iq "credit default swap" $file 
				 	...
				 	then
				 		if [ -d /home2/vvsaripalli/master/m/$(basename $dir) ]
				 		then
				 			(cp $file /home2/vvsaripalli/master/m/$(basename $dir) )
				 		else
				 		(cd /home2/vvsaripalli/master/m && mkdir "$(basename $dir)" && cp $file /home2/vvsaripalli/master/m/$(basename $dir))
				 		fi
				 	fi
